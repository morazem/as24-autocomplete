    ...
    if (closestByTag(rootElement)(e.target) === rootElement) {
        ...
        if (isListVisible(list)) {
            if (userFacingInput.classList.contains('error')) {
                ...
                const theFirstItem = $('.as24-autocomplete__list-item--selected', list);
...
function elementAttached() {
     ...
     */
    const userFacingInput = $('input[data-role="user-query"]', root);

    /**
     * Hidden input in which we actually set the value
     * @type {HTMLInputElement}
     */
    const valueInput = $('input[data-role="value"]', root);
...
function onAttributeChanged(attrName, oldVal, newVal) {
    /** @type {HTMLInputElement} */
    const userFacingInput = $('input[data-role="user-query"]', this);
        ...
        return document.registerElement('as24-autocomplete', {
            prototype: Object.assign(
                 ...
                 */
                {
                     ...
                     */
                    selectedValue() {
                        return $('input[data-role="value"]', this).value;
                    },
                    /**
                     ...
                     */
                    userQuery() {
                        return $('input[data-role="user-query"]', this).value;
                    },
                    /**
                    ...
                    reset() {
                        ...
                        /** @type {HTMLInputElement} */
                        const valueInput = $('input[data-role="value"]', this);
