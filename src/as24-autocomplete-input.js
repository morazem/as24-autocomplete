...
function elementAttached() {
     ...
     */
    const userFacingInput = $('[data-role="user-query"]', root);

    /**
     * Hidden input in which we actually set the value
     * @type {HTMLInputElement}
     */
    const valueInput = $('[data-role="value"]', root);
...
function onAttributeChanged(attrName, oldVal, newVal) {
    /** @type {HTMLInputElement} */
    const userFacingInput = $('[data-role="user-query"]', this);
            ...
            prototype: Object.assign(
                 ...
                 */
                {
                    ...
                    reset() {
                        ...
                        /** @type {HTMLInputElement} */
                        const valueInput = $('[data-role="value"]', this);
